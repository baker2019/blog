...
class HouseAdmin(admin.ModelAdmin):
    list_display = ['title', 'category', 'price1', 'price2', 'image_tag', 'status']
...
class CategoryAdmin2(DraggableMPTTAdmin):
    ...
    list_display = ('tree_actions', 'indented_title', 'related_houses_count', 'related_houses_cumulative_count')
